...
class Topology:
    def __init__(self, topology_file):
        ...
        self.name = os.path.basename(topology_file)
        self.Switches = {} # Key = Switch_ID: 0, 1, 2, ...
        self.Links = {}     # Key = Link_ID: (0, 1), (1, 4), (4, 1)
    ...
    def get_or_add_link(self, from_sid, to_sid, capacity = MAX_CAPACITY, weight = 1):
        lid = (from_sid, to_sid)
