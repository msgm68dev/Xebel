...
import sys
V=5
print("A wheel of length N contains, N+2 swithes, such that s0 is not connected to others, s1,...,sN are a ring and all ring nodes connected to s(N+1)")
V=int(input("Enter wheel length? "))
class MyTopo( Topo ):
