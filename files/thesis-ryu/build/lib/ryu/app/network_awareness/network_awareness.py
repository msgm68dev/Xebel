...
# m.salari
from mostafa_utils import OutSource_Routing 
...
class NetworkAwareness(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.name = "awareness"
        # m.salari:
        self.port_to_dst = {}       # (src_dpid,src_port)->(dst_dpid, dst_port)
        # \m.salari
    ...
    def switch_features_handler(self, ev):
        ...
        msg = ev.msg
        # self.logger.info("xx switch:{} connected msg {}".format(datapath.id, msg))
        self.logger.info("xx switch:%s connected", datapath.id)
    ...
    def get_graph(self, link_list):
        ...
        # m.salari: send full graph
        # graph_bytes = dumps(self.graph)
        # try:
        #     javab = self.outsource.send_graph(graph_bytes) 
        #     self.logger.info("**** graph {}".format(javab))
        # except Exception as e:
        #     print("**** graph  Error in sending GRAPH: {}".format(str(e)))
        # \m.salari
        return self.graph
    ...
    def create_interior_links(self, link_list):
        ...
        for link in link_list:
            ...
            # m.salari:port_to_dst
            self.port_to_dst[(src.dpid, src.port_no)] = (dst.dpid, dst.port_no)
            # \m.salari
    ...
    def get_topology(self, ev):
        ...
        # print(" ... get_topology : link_to_port = {}".format(self.link_to_port)) # m.salari deleteme

        # m.salari: az asle muzixing bargardundam
    ...
    def k_shortest_paths(self, graph, src, dst, weight='weight', k=1):
        ...
        """
        # m.salari:
        # print("k_shortest_paths {} {} {}".format(src, dst, __name__))
        # \m.salari
    ...
    def show_topology(self):
        # m.salari
        print("I disabled network_awareness.py: NetworkAwareness > show_topology")
        return
        # \m.salari
...
# m.salari: topology changes

    @set_ev_cls(event.EventSwitchEnter)
    def _event_switch_enter_handler(self, ev):
        msg = ev.switch.to_dict()
        self.outsource.send_topology_change("switch", "add", msg)
    @set_ev_cls(event.EventSwitchLeave)
    def _event_switch_leave_handler(self, ev):
        msg = ev.switch.to_dict()
        self.outsource.send_topology_change("switch", "del", msg)
    @set_ev_cls(event.EventLinkAdd)
    def _event_link_add_handler(self, ev):
        msg = ev.link.to_dict()
        self.outsource.send_topology_change("link", "add", msg)
    @set_ev_cls(event.EventLinkDelete)
    def _event_link_delete_handler(self, ev):
        msg = ev.link.to_dict()
        self.outsource.send_topology_change("link", "del", msg)
    @set_ev_cls(event.EventHostAdd)
    def _event_host_add_handler(self, ev):
        msg = ev.host.to_dict()
        self.outsource.send_topology_change("host", "add", msg)
    @set_ev_cls(event.EventHostDelete)
    def _event_host_add_handler(self, ev):
        msg = ev.host.to_dict()
        self.outsource.send_topology_change("host", "del", msg)
# \m.salari